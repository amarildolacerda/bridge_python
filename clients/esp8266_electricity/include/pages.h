...
.valor{font-size:3.5rem;font-weight:700;margin:8px 0;color:#f7f8f8}
.valor .unit{font-size:1.2rem;color:#8a8f98;font-weight:400}
.label{color:#8a8f98;font-size:.85rem;margin-bottom:16px}
.badge{display:inline-block;padding:6px 16px;border-radius:999px;font-size:.82rem;font-weight:700;margin-bottom:16px}
.badge.low{background:rgba(39,166,68,0.15);color:#27a644}
.badge.med{background:rgba(255,152,0,0.15);color:#f5a623}
.badge.high{background:rgba(229,72,77,0.15);color:#e5484d}
...
.meta-value .small{font-size:.75rem;color:#8a8f98;font-weight:400}
...
if(d.bridge_connected)bs.innerHTML='<a href="http://'+d.bridge_ip+':'+d.bridge_port+'" target="_blank" style="color:#5e6ad2;text-decoration:none">conectado</a>';
