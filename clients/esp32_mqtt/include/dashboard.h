...
td.id{color:#38bdf8;font-weight:600}
...
.status-msg{text-align:center;padding:40px;color:#64748b}
...
<div class="stat"><div class="num" id="online">0</div><div class="label">Online</div></div>
<div class="stat"><div class="num" id="offline">0</div><div class="label">Offline</div></div>
</div>
<div class="refresh">Atualizado: <span id="ts">--</span></div>
<table>
...
if(tot===0){h='<tr><td colspan="5" class="status-msg">Nenhum cliente nos &uacute;ltimos 5 min</td></tr>';}
else{
d.forEach(x=>{
...
}catch(e){document.getElementById('ts').textContent='erro';}
}
load();
