...
extern "C" void app_main()
{
    ...
    // Forçar um PIN específico
    esp_matter::config_t config;
    config.setup_pin = 20202021; // PIN padrão
    config.setup_discriminator = 3840;

    // Inicializar com esse PIN
    esp_matter::start(config);
}
